...
Bad:
> Build me a Stellar wallet with stablebond integration.
...
- [Add country-specific assets and rails, e.g., CETES via SPEI (MX), TESOURO via PIX (BR). See `countries/<code>/Dev_Setup_Guide.md`.]
```
