...
The three country-agnostic docs (`Claude_Code_Guide.md`, `Recommended_AI_Tools.md`, `Starter_Prompts.md`) live at the root on purpose — they're the first things a new builder should read, regardless of country.
