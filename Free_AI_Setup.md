...
### 2.0 Start here: FreeLLMAPI — stack 16 free tiers behind one endpoint
...
Read this section before working through 2a–2e below. Most of the providers listed in 2a–2e can be plugged into FreeLLMAPI; once they are, you point your tools at `http://localhost:3001/v1` and never juggle 16 keys again.
...
Open `http://localhost:3001`, register the admin account, paste your free-tier keys on the **Keys** page (every provider listed in section 2a is supported), reorder the **Fallback Chain**, and grab the unified API key from the **Keys** page header.
...
- You already have, or are planning to register for, multiple free-tier accounts.
